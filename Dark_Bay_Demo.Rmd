...
#Source relevant functions (eventually I'll figure out how to bring these in as a package...)
source("GIW_burn.R")
source("GIW_identification.R")
source("GIW_subshed_delineation.R")
source("GIW_stage_storage.R")
source("GIW_max_inundation.R")
